...
if (qtecom > 0) {
    ...
    document.write("remise " + remise + "% soit -" + reduc + "€ soit " + total + "€ et frais_de_port " + port + "% soit " + calport + "€ Total à payer " + pap + "€")

} else {
    //la condition que la quantité n'est pas égal à zero
    document.write("vous ne pouvez pas saisir " + qtecom + " produit recommencez il y a une erreur")
